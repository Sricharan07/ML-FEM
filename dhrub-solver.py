...
ax_mesh = axs[2,2]
ax_mesh.set_title("Mesh outline with hole shown as missing elements")
...
plt.tight_layout()
# save combined contour figure for later inspection
output_dir = Path("solver-plots")
output_dir.mkdir(parents=True, exist_ok=True)
timestamp = pytime.strftime("%Y%m%d-%H%M%S")
plot_path = output_dir / f"dhrub_solver_contours_{timestamp}.png"
fig.savefig(plot_path, dpi=300)
print(f"Saved contour figure to {plot_path}")
